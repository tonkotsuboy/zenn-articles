---
title: "全ブラウザ対応。コンテナクエリ @container の新しいレスポンシブデザインを完全理解する"
emoji: "🎁"
...
React・Vue・Svelte・Astro などのコンポーネントをベースとした開発と特に相性がいいです。コンポーネントの開発者は、**そのコンポーネントがどこにどう配置するかを気にする必要がなく、あくまで自分がコンテナサイズに対してどのような表示になるかだけの関心を持てばよい**からです。
