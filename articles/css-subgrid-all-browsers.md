...
本日（2023/09/12）、Chrome 117のリリースでCSSのSubgridに対応しました。
...
subgridは、Firefox・Safariで対応済みでしたが、**本日2023/09/12）リリースされたChrome 117でも対応しました**。Microsoft Edgeでは、9月14日週にリリースされる117で対応します。 これにより、**全ブラウザでsubgridが使えるようになります**。
